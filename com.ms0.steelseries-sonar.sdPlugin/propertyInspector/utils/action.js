 ...
 * 
 *      1 => Tools and main file are separated - Import as needed
 *      2 => $settings - Global persistent data proxy ※
 *      3 => No need to care about context - Communicate with plugins anytime
 *      4 => Note: To avoid naming conflicts, do not use $ related names and JQuery library
 * 
 * ===== CJHONG ========================================== 2023.10.10 =====>
 */
...
// Software entry function - To maintain compatibility with Elgato we use the same function names so your plugins can be compatible with Elgato software
